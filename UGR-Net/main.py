...
from train_gamma import TrainDG
...
if __name__ == '__main__':
    ...
    parser.add_argument('--gamma', type=str, default="0.5,1.0,1.5,2.0,2.5,3.0", help='Comma separated gamma values')
help='Gamma value for uncertainty gating (default: 1.0)')
    ...
    parser.add_argument('--random_type', type=str, default='TriD')
    ...
    parser.add_argument('--Source_Dataset', nargs='+', type=str, default=['ORIGA','Harvard' ,'Refuge2'],
                        help='Refuge2/ RIMONE/Harvard/ORIGA')
    parser.add_argument('--Target_Dataset', type=str, default='**',
                        help='Refuge2/ RIMONE/Harvard/ORIGA')

    parser.add_argument('--path_save_result', type=str, default='./test_results/')
    parser.add_argument('--path_save_model', type=str, default='./test_models/')
    parser.add_argument('--path_save_log', type=str, default='./test_logs/')
    parser.add_argument('--dataset_root', type=str, default='F:/dataset/')
